        ...
        <div className="flex justify-center items-center mt-6 flex-wrap gap-2">
          ...
          {startPage > 1 && (
            <>
              <button
                onClick={() => paginate(1)}
                className="bg-gray-800/70 border border-blue-500/30 text-blue-300 px-3 py-1.5 rounded-md text-sm min-w-10 text-center cursor-pointer hover:bg-gray-700/70 hover:border-blue-500/50 transition-colors duration-200"
              >
                1
              </button>
            ...
            <thead className="bg-gradient-to-r from-gray-800/80 to-blue-900/80 border-b border-blue-500/30 sticky top-0 z-10">
              <tr>
                ...
                {visibleColumns.proyectos.includes("fecha_inicio") && (
                  <th className="px-4 py-3 text-left text-blue-300">
                    Fecha Inicio
                  </th>
                )}
              </tr>
  ...
  return (
    <div className="mt-4 pb-10 w-full px-2 sm:px-4 transition-opacity duration-300 ease-in-out overflow-x-hidden">
      ...
      {loading ? (
        ...
        <div
          className="bg-gray-800/80 rounded-lg p-6 border border-blue-500/30 animate-fadeInUp"
        ...
        >
          ...
          <h3
            className={`text-xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 transform transition-all duration-300 ${
              tabTransitioning ? "opacity-0 scale-95" : "opacity-100 scale-100"
            }`}
          >
          ...
          >
            ...
            {activeTab === "usuarios" && (
              <div
                className={`transform transition-all duration-300 ease-in-out ${transitionClass}`}
              >
                {viewMode === "table" && !isMobile ? (
                  <UsuarioTable />
                ) : (
