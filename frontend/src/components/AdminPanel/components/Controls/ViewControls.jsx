...
function ViewControls({
  ...
  const cardsOnlyModules = ["carreras", "especialidades", "unidades","lineas","niveles","tiposestudiante","jefesareas","roleventos","tipoherramientas"]; //Alan, Aquí puedes agregar más módulos en el futuro
