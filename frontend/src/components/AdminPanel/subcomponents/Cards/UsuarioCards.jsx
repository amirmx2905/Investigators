...
function UserCard({ usuario, index, onEdit, onDelete }) {
  ...
  // Determinar la notificación de vínculo
      ...
      <div className="p-4">
        ...
        <div className="flex items-center mb-2">
          <div className="flex-shrink-0 h-12 w-12 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white font-bold text-xl relative">
            ...
            }`} title={usuario.activo ? "Activo" : "Inactivo"}></span>
          </div>
          
          <div className="ml-3 flex-grow min-w-0">
            <h3 className="font-semibold text-white flex items-center space-x-2">
              <span className="truncate">{usuario.nombre_usuario}</span>
              <span className={`text-xs px-2 py-0.5 rounded-full border ${rolColor} whitespace-nowrap`}>
                {usuario.rol || "Usuario"}
              </span>
            </h3>
        ...
        <div className="bg-gradient-to-r from-gray-800/70 to-gray-900/70 rounded-lg p-2 mb-3 flex items-center justify-between">
          <div className="text-sm text-gray-300 flex items-center">
            ...
            <span className="ml-1.5 font-medium text-gray-200">{usuario.id}</span>
          </div>
        ...
        <div className={`transition-all duration-300 overflow-hidden space-y-3 ${
          ...
          <div className="bg-gradient-to-r py-2.5 px-3 rounded-md text-white text-sm flex items-center justify-between"
            ...
            <div className="flex items-center">
              ...
              <span className="text-blue-300 max-[435px]:hidden">Vinculación:</span>
            </div>
            <div className="flex items-center max-[435px]:mx-auto">
              {vinculacion.showText && (
                <span className="text-gray-300 mr-2 truncate max-w-[120px]">{vinculacion.text}</span>
              )}
              <span className={`text-xs px-1.5 py-0.5 rounded bg-gradient-to-r ${vinculacion.color} text-white`}>
                {vinculacion.badge}
              </span>
            </div>
          </div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="bg-gray-700/40 hover:bg-gray-700/50 rounded-md p-2.5 transition-colors duration-200 flex items-center justify-between w-full">
              ...
              <span className="text-gray-200 font-medium truncate max-w-[60%]">{usuario.nombre_usuario}</span>
            </div>
            ...
            <div className="bg-gray-700/40 hover:bg-gray-700/50 rounded-md p-2.5 transition-colors duration-200 flex items-center justify-between w-full">
              ...
              <span className="text-gray-200 font-medium truncate max-w-[60%]">{usuario.rol}</span>
            </div>
