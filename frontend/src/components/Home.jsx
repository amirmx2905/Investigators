...
function Home() { //sirve como landing page
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-160px)] px-4 py-6 md:px-8 md:py-10">
      ...
      >
        El sistema de investigación con tecnología avanzada para analizar y
        gestionar casos.
      </p>
      ...
      >
        ...
        <div
          className="bg-gray-800/70 backdrop-blur-sm p-4 sm:p-5 md:p-6 rounded-lg 
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-300">
            Explora información y obtén insights mediante nuestras herramientas
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-300">
            Administra tus investigaciones de forma eficiente con nuestra
      ...
      {currentUser?.role === "admin" && (
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-300 mb-3 sm:mb-4">
            Como administrador, tienes acceso a funciones avanzadas a través del
            Panel de Control.
          </p>
